...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        def varasto_hae_tuote(tuote_id):
            ...
            if tuote_id == 2:
                return Tuote(2, "omena", 3)
            if tuote_id == 3:
                return Tuote(3, "suklaalevy", 7)
    ...
    def test_ostoskoriin_lisataan_tuote_jota_on_tarpeeksi_ja_ei_ole_tarpeeksi_jonka_jalkeen_ostoksen_paatyttya_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
